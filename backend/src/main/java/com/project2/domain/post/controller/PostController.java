...
public class PostController {
	...
	@GetMapping
	public RsData<Page<PostResponseDTO>> getPosts(@RequestParam(defaultValue = "created_at") String sortBy,
		Pageable pageable) {
		Page<PostResponseDTO> posts = postService.getPosts(sortBy, pageable);
